...
public class BDC_Demo_03_definitions {
	...
	public void bdc_user_having_valid_credentials() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
		System.out.println("bdc user having valid credentials");
	}

	@Given("user tries to provide the data for the login process")
	public void user_tries_to_provide_the_data_for_the_login_process() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
		System.out.println("user tries to provide the data for the login process");
	}
	...
	@Given("user clicks on the logout button to close the window")
